...
class ReportabilidadController extends Controller
{
    ...
    public function showResults(Request $request)
    {
        ...
        if ($cant != 0) {
            ...
            $porcentajeParticipacionOrgSocial = $participaOrgSocial * 100 / $cant;
        } else {
            ...
            $porcentajeParticipacionOrgSocial = 0;
        }

        return view('reportabilidad.createFichaPaciente', compact('cant', 'porcentajeFemenino', 'porcentajeMasculino', 'ingresoAnual', 'ingresoMensual', 'porcentajeCredencialEntregada', 'porcentajeCredencialTramite', 'atencionAnual', 'atencionMensual', 'porcentajeAdulto', 'porcentajeJoven', 'porcentajeAdultoMayor', 'porcentajeFonasa',
            ...
            'isapreDipreca', 'isapreCapredena', 'isapreFerroSalud', 'isapreOtro', 'porcentajeRSTiene', 'porcentajeRSTramite', 'porcentajeParticipacionOrgSocial'));
    ...
    public function showResutlPorFecha(Request $request)
    {
        ...
        $cantIngresadosAño = Beneficiario::whereYear('created_at', '=', $año)->count();
        $cantIngresadosMes = Beneficiario::whereYear('created_at', '=', $año)->wheremonth('created_at', '=', $mes)->count();
        $atencionAnual = PrestacionRealizada::whereYear('fecha', '=', $año)->count();
        $atencionMensual = PrestacionRealizada::whereYear('fecha', '=',$año)->whereMonth('fecha', '=', $mes)->count();
