    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        	...
        	<div class='form-group'>
			    <div class='controls'>
		        	...
		        	@if(old('domicilio_calle'))
		        		"{{ old('domicilio_calle') }}"
		        	@elseif(isset($persona) && $persona->domicilio != null && $persona->domicilio->calle != null)
		...
		<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <div class='form-group'>
			    ...
			    @elseif(isset($persona) && $persona->domicilio != null && $persona->domicilio->numero !=null)
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <div class='form-group'>
			    ...
			    @if(old('domicilio_block'))
			    	"{{ old('domicilio_block') }}"
			    @elseif(isset($persona) && $persona->domicilio != null && $persona->domicilio->bloque !=null)
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class='form-group'>
			    <div class='controls'>
				    ...
				    @elseif(isset($persona) && $persona->domicilio != null && $persona->domicilio->numero_depto !=null)
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class='form-group'>
			    <div class='controls'>
				    ...
				    @elseif(isset($persona) && $persona->domicilio != null && $persona->domicilio->pobl_vill !=null)
