<div class="form-group">
    ...
    <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group'>
        <select style="width:100%;" name='sistema_proteccion' class='form-control capitalize select-nomore'data-placeholder='Seleccione o agregue sistemas de proteccion' id="sistema_proteccion">
