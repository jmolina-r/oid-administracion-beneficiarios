                            ...
                            <div class='col-sm-12'>
                                <div class='box'>
                                    <div class='box-content box-padding'>
                                        <h2>Confirmar Eliminación de la Prestación:</h2>
                                        <hr>
                                        <div clas="col-xs-12">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <h3>Nombre de la Prestación:</h3>
                                                </div>
                                                <div class="col-md-4">
                                                    <h3 class="capitalize">{{ $prestacion->nombre }}</h3>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <h3>Área de la Prestación:</h3>
                                                </div>
                                                <div class="col-md-4">
                                                    <h3 class="capitalize">{{ $prestacion->area }}</h3>
                                                </div>
                                            </div>
                                        </div>
                                        <form class='validate-form' method="POST" action="{{ route('malla.eliminarPrestacion') }}">
                                            <input id="id" type="hidden" name="id" value="{{ $prestacion->id }}">
                                            <hr>
                                            <div class="col-md-6">
                                                <a class="btn btn-primary btn-block" href="{{route('malla.listaPrestaciones')}}">Volver</a>
                                            </div>
                                            <div class="col-md-6">
                                                <button class='btn btn-block btn-success' type="submit">Eliminar</button>
                                            </div>
                                            {{ csrf_field() }}
                                        </form>
                                        <hr>
