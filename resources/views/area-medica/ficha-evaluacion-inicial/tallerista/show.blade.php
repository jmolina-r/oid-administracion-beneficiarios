                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-lg-6">
                                    <p class="capitalize"><span class="tit">Nombre del taller</span><br>{{ $fichaTaller->nombre_taller }}</p>
                                    <p class="capitalize"><span class="tit">Alergias</span><br>{{ $fichaTaller->objetivo }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
