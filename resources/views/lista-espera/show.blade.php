...
@section('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $('#tabla-lista-espera').DataTable();
                ...
                $('#btn-guardar').click(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            window.location.replace("/beneficiario/listaEspera/show/" + $('#id').val());
                        },
                        error: function (jqXHR, textStatus, errorThrown) {
                        ...
                        <div class='row'>
                            <div class='col-sm-12'>
                                <div class='page-header'>
                                    <h1 class='pull-left'>
                                        <input id="id" name="id" type="hidden" value="{{$id_demanda}}">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row dataTable">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <select id="select-descripcion" class="form-control">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="details-control">
                                                                            <button id="btnHistorial"
                                                                                    class="btnHistorial btn btn-primary btn-xs"
